...
public class NavigatorExport {
   ...
   // public static final String VISTA_2 = "vista2.fxml";
     ...
     */
    public static void setExportController(ExportPageController mainController) {
        NavigatorExport.exportPageController = mainController;
    }  
    public static ExportPageController getExportController() {
	...
	public static void setImportCurrent(DatabaseImportModule importCurrent) {
		NavigatorExport.importCurrent = importCurrent;
	}
    ...
    public static void loadVista(String fxml,String bundle) {
        try {
    		...
    		exportPageController.setVista(FXMLLoader.load(NavigatorExport.class.getResource(fxml),bundle1));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
